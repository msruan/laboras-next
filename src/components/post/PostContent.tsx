	...
	return (
		<>
			...
			>
				...
				{fullPage ? (
					<footer className="text-white opacity-70 text-xs mt-10 border-t-purple-50 flex items-center">
						<p className="w-3/4">
							Data de publicação:{" "}
							{new Date(post.createdAt).toLocaleDateString()}
						</p>
						<div className="flex flex-row justify-between pr-7 pb-1 h-fit w-1/4">
