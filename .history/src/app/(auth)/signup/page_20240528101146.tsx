...
import { register } from "@/actions/AuhtAction";
    ...
    <Card className="w-full max-w-md text-wrap ">
      <CardHeader>
        ...
        <CardDescription className="text-purple-300">
          Already registered?{" "}
          <Link className="underline font-semibol hover:text-white" href={"/login"}>
            Login
          </Link>
        </CardDescription>
      </CardHeader>
      ...
      <CardFooter>
        <p className="text-sm text-muted-foreground text-center text-wrapp">
          By entering on our platform, u let us to sale your personal data.
        </p>
      </CardFooter>
    </Card>
  );
...
function RegisterForm() {
  ...
  const [state, handleAction] = useFormState(register, undefined);
